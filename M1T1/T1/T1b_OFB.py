...
# Output
print('2- ENCRYPTED MESSAGE WITH STATIC KEY AND OFB: ', cryptogram)

# Init decryptor
decryptor = cipher.decryptor()
clearText = decryptor.update(cryptogram) + decryptor.finalize()
print('3- DECRYPTED MESSAGE: ', clearText)
print('ORIGINAL MESSAGGE AND DECRYPTED MESSAGE ARE EQUAL ->', message.decode('utf8') == clearText.decode('utf8'))
